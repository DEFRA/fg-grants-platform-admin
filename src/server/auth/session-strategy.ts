...
import { loginPath, redirectCookieName, redirectCookieOptions } from './oidc.ts'
import {
  clearAuthSession,
  getAuthSession,
...
function redirectToLogin(request: Request, h: ResponseToolkit) {
 ...
 */
function isRefreshRejectedByEntra(error: unknown) {
