...
describe('#applicationsAdminController', () => {
  ...
  test('Should provide expected response for the applications admin role', async () => {
  ...
  test('Should forbid a signed in user holding only the operations admin role', async () => {
    const { cookie } = await signIn(server, {
      name: 'Ada Lovelace',
